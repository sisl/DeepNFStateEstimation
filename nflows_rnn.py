...
embedded_context = flow_rnn._embedding_net(ctx_test)
...
region1, _ = flow_rnn._transform.inverse(circle1, context = rep_embedded_context)
region2, _ = flow_rnn._transform.inverse(circle2, context = rep_embedded_context)
region3, _ = flow_rnn._transform.inverse(circle3, context = rep_embedded_context)
