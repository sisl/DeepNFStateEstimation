...
make_gif("./figs/experiments/lstm/tmp/", "./figs/experiments/lstm/seq12.gif", delete_frames=True)
...
embedded_context = flow_lstm._embedding_net(ctx_test)
...
region1, _ = flow_lstm._transform.inverse(circle1, context = rep_embedded_context)
region2, _ = flow_lstm._transform.inverse(circle2, context = rep_embedded_context)
region3, _ = flow_lstm._transform.inverse(circle3, context = rep_embedded_context)
